...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // 5. Contact Form to WhatsApp Redirect
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', (e) => {
            ...
            const phoneNumber = "584120520752"; // Tu número de WhatsApp

            // Formatear el mensaje para WhatsApp usando códigos Unicode para evitar problemas de codificación
            const fullMessage = "\u00A1Hola! \u2728 Vengo de la p\u00E1gina web de Brisas de Colibr\u00ED. \uD83D\uDD4A\uFE0F\n\n*Mis datos:*\n\uD83D\uDC64 *Nombre:* " + name + "\n\uD83D\uDCE7 *Correo:* " + email + "\n\n*Consulta:*\n" + message;
            ...
            setTimeout(() => {
                // Abrir WhatsApp con el mensaje correctamente codificado
